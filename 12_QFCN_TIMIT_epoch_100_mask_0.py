...
######################### Training data #########################
Train_Noisy_lists = get_filepaths("/home/dwadelin/Corpus/TIMIT_SE/Train/Noisy/")#training noisy set
Train_Clean_paths = "/home/dwadelin/Corpus/TIMIT_SE/Train/Clean/"
...
with open('12_QFCN_TIMIT_epoch_100_mask_0.json','w') as f:    # save the model
    f.write(model.to_json()) 
#checkpointer = ModelCheckpoint(filepath='12_QFCN_TIMIT_epoch_100_mask_0.hdf5', verbose=1, save_best_only=True, mode='min')
...
######## choose the callback function ########
bit_width = 0 # 0, 4, 8, 12, 16, 20, 23
mask_bit_width(bit_width)
set_hdf5_name('12_QFCN_TIMIT_epoch_100_mask_0.hdf5')

if bit_width == 0:
    callback_function = Mycallback_none()
else:
    callback_function = Mycallback_epoch()
